...
Route::prefix('newlay')->group(
    function () {
        Route::get('/', 'HomeController@gohome')->name('index');
        Route::get('/indpost', 'HomeController@NewIndex')->name('indpost');
    }
);
...
Route::post('notesstore', 'VideoComRateController@storeNote')->middleware('auth')->name('storeNote');
Route::post('ratesvedio', 'VideoComRateController@getRate')->middleware('auth')->name('getRate');
...
Route::get('/blogselements', 'HomeController@indexBlogelement')->name('public.blog.index');
Route::get('/blogs', 'HomeController@indexBlog')->name('public.blog.indexelement');

Route::get('/certificates', 'HomeController@certificates')->name('public.certificates');
...
Route::get('/course/{course}', 'packageController@packageByCourse')->name('package.by.course');
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/certificates-faq', 'FaqCorceController@index')->name('admin.FaqCorce');
    Route::get('/create/certificates-faq', 'FaqCorceController@create')->name('admin.create.FaqCorce');
    Route::post('/store/certificates-faq', 'FaqCorceController@store')->name('admin.store.FaqCorce');
    ...
    Route::prefix('blog')->middleware('auth:admin')->group(function () {
        ...
        Route::get('/seoPage', 'PostController@seoPage')->name('blog.seoPage');
        Route::post('/gatData/{id}', 'PostController@gatData')->name('blog.gatData');
        Route::post('/updateSeo', 'PostController@updateSeoData')->name('blog.updateSeoData');
    ...
    Route::prefix('review')->middleware('auth:admin')->group(function () {
        ...
        Route::get('/destroy/{id}', 'ReviewController@delete')->name('review.destroy');
        
        Route::get('/homeindex', 'ReviewController@homeindex')->name('review.homeindex');
        Route::get('/homecreate', 'ReviewController@homecreate')->name('review.homecreate');
        Route::post('/homestore', 'ReviewController@homestore')->name('review.homestore');
        Route::get('/homedestroy/{id}', 'ReviewController@homedelete')->name('review.homedestroy');
        
        Route::get('/showmesasage', 'ReviewController@showmesasage')->name('message.showmesasage');
        Route::post('/sendreply/{id}', 'ReviewController@sendreply')->name('message.sendreply');
        Route::get('/destroy1/{id}', 'ReviewController@deletemesasage')->name('message.deletemesasage');
    });
    
    Route::prefix('setting')->middleware('auth:admin')->group(function () {
        Route::get('/setting', 'AllSettingController@show')->name('setting.show');
        Route::post('/setting', 'AllSettingController@setting')->name('setting.setting');
        Route::post('/getData', 'AllSettingController@getData')->name('setting.getData');
      
    });

     Route::post('/storemesasage', 'ReviewController@storemesasage')->name('review.storemesasage');
     
     Route::post('/storesubscribe', 'ReviewController@storesubscribe')->name('review.storesubscribe');
    ...
    Route::delete('/books/destroy/{id}', 'BookController@destroy')->name('books.destroy');
    
    Route::get('/books/indexbook', 'HomeController@indexbook')->name('books.indexbook');
    ...
    Route::get('/course/seo', 'packageController@seopage')->name('packages.seopage');

    Route::post('updateDetails', 'packageController@updatedetails')->name('cource.updatedetails');
    Route::post('/course/seo/{id}', 'packageController@getCourceDetailsData')->name('cource.details');

    Route::get('/certificateindex', 'packageController@certificateindex')->name('certificate.certificateindex');
    Route::post('certificatedelete/{id}', 'packageController@certificatedelete')->name('certificate.certificatedelete');
...
Route::get('/books/{slug}', 'BookController@singleBook')->name('singleBook.index');
Route::post('/searchbook', 'BookController@searchBook')->name('searchBook');
Route::get('/books', 'BookController@allBooks')->name('allBooks.index');
...
Route::get('/my-invoices', 'InvoiceController@myInvoices_view')->middleware('auth')->name('my.invoice.view');

Route::get('/my-invoicesprint/{id}', 'InvoiceController@print')->middleware('auth')->name('my.invoice.print');
...
Route::get('generate/payment/coupon/{id}', function (
...
Route::get('AllCourses', 'HomeController@allCours')->name('allcourse');
...
//     return response()->view('sitemap.ro')->header('Content-Type', 'text/xml');;
// });
