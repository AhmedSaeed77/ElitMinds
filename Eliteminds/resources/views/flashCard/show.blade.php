                            ...
                            @if($flashCard)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2" style="text-align: right;">
                                        {{$flashCard->created_at->diffForHumans()}}
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5">
                                        <img src="{{url('storage/flashcard/'.basename($flashCard->img))}}" width="100%" height="100%" >
                        ...
                        <div class="portlet-body">
                            <h3 class="sbold blog-comments-title">Leave A Comment</h3>
                                <form action="{{route('comment.store')}}" method="post">
                                    ...
                                    <input type="hidden" name="item_id" value="{{$flashCard->id}}">
