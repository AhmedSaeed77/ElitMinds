            ...
            <div class="row gx-10">
                <div class="col-lg-12">
                    ...
                    <div class="blog-details-wrapper">
                        ...
                        <!--@isset($post->youtube)-->
                        <!--  <iframe width="700" height="315" src="https://www.youtube.com/embed/{{$post->youtube}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>-->
                        <!--@endisset-->
                    </div>
