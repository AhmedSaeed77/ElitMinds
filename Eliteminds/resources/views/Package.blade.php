...
@section('meta')
    <meta name="title" content="{{ $i->package->meta_tittle ?? ''  }}">
    <meta name="description" content="{{ $i->package->meta_description ?? ''  }}">
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Course",
      "name": "{{ Transcode::evaluate($i->package)['name'] }}",
      "description": "{{ $i->package->meta_description ?? ''  }}",
      "provider": {
        "@type": "Organization",
        "name": "Eliteminds",
...
@section('content')
    ...
    <div class="section section-padding mt-n10" id="app-1">
        <div class="container">
            <div class="row gx-10 " style="margin-right:0">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                            <!--<input type='hidden' value="{{$pricing['localized_price']}}" /> -->
                            <!--    <input type='hidden' value="{{$pricing['localized_coupon_discount']}}" /> -->
                            <!--         <input type='hidden' value="{{$pricing['localized_coupon_discount']}}" />-->
                            <!--          <input type='hidden' value="{{$pricing['localized_original_price']}}" />-->
                            <!--          <input type='hidden' value="{{$pricing['currency_code']}}" />-->
