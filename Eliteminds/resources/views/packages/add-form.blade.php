        ...
        <form method="POST" id="packageForm" action="{{route('packages.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group  row mb-0 ">
                    ...
                    <div class="col-5">
                        <input class="form-control" type="text" name="name_ar" placeholder="Package Name_ar"  value="{{old('name_ar')}}"/>
                    </div>
                </div>
                <div class="form-group  row mb-0">
                ...
                <div class="form-group row mb-0">
                    <div class="col-6 form-group mb-0">
                        <strong>
                            ...
                            <input class="form-control" type="text" placeholder="telegram "  name="telegram" id="telegram" value="{{old('telegram')}}"/>
                        </strong>
                    </div>
                    <div class="col-6 form-group mb-0">
                        <strong>
                ...
                <div class="card card-custom  mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <textarea name="what_you_learn" id="kt-ckeditor-3"  placeholder="English">
                                    {!! old('what_you_learn') !!}
                                </textarea>
                            </div>
                              <div class="col-md-6">
                                <textarea name="what_you_learn_ar" id="kt-ckeditor-4">
                ...
                <div class="card card-custom  mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <textarea name="plandes" id="kt-ckeditor-11"> {!! old('plandes') !!} </textarea>
                            </div>
                            <div class="col-md-6">
                                <textarea name="plandes_ar" id="kt-ckeditor-12" placeholder="عربي">{!! old('plandes_ar') !!}</textarea>
                            </div>
                ...
                <div class="card card-custom  mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <textarea name="requirement" id="kt-ckeditor-5"  placeholder="English">
                                    {!! old('requirement') !!}
                                </textarea>
                            </div>
                               <div class="col-md-6">
                                <textarea name="requirement_ar" id="kt-ckeditor-6">
                                    {!! old('requirement_ar') !!}
                                </textarea>
                            </div>
                        </div>
                ...
                <div class="card card-custom  mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <textarea name="who_course_for" id="kt-ckeditor-7"  placeholder="English">
                                    {!! old('who_course_for') !!}
                                </textarea>
                            </div>
                              <div class="col-md-6">
                                <textarea name="who_course_for_ar" id="kt-ckeditor-8">
                ...
                <div class="card card-custom  mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <textarea name="enroll_msg" id="kt-ckeditor-9"  placeholder="English">
                                    {!! old('enroll_msg') !!}
                                </textarea>
                            </div>
                            <div class="col-md-6">
                                <textarea name="enroll_msg_ar" id="kt-ckeditor-10">
                                    {!! old('enroll_msg_ar') !!}
                                </textarea>
                            </div>
                        </div>
