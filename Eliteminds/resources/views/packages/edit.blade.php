            ...
            <div class="card-body">
                ...
                <div class="card card-custom  mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <textarea name="plandes" id="kt-ckeditor-11"> {!! $package->plandes !!} </textarea>
                            </div>
                            <div class="col-md-6">
                                <textarea name="plandes_ar" id="kt-ckeditor-12" placeholder="عربي">{!! $packageTransCodes['plandes'] !!}</textarea>
                            </div>
                            <div class="col-md-12 my-2">
                                <textarea name="plandes_fr" id="kt-ckeditor-fr-13" placeholder="French">{!! $packageTransCodes_fr['plandes'] !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-custom  mb-5 adawe">
                    ...
                    <div class="row">
                        <div class="col-6 form-group m-5">
                            <strong>
                                <label class="col-form-label" for="meta_t"><b> meta tittle </label>
                                <input class="form-control" type="text" id="meta_t" name="meta_tittle" placeholder="meta_tittle"
                                        value="{{ $package->meta_tittle }}"/>
                            </strong>
                        </div>
                        <div class="col-12 m-5">
                             <label class="col-form-label" for="meta_d"><b> meta_description  </label>
                            <textarea class="form-control" cols="40" id="meta_d" name="meta_description">
