                    ...
                    <div class="mobile-menu">
                        ...
                        <nav>
                            <ul>
                                ...
                                @else
                                    <li><a href="{{route('login')}}">Login</a></li>
                                    <li><a href="{{route('register')}}" title="signup">SignUp</i></a></li>
                                @endif
                            </ul>
                        </nav>
                    </div>
    ...
    <div class="container">
        <div class="page-breadcrumb-content text-center">
            <div class="page-breadcrumb-title">
                <h2 class="breadcrumb-head black bold">Free Resource <span>Demo videos</span></h2>
            </div>
                ...
                <div class="col-md-12">
                    <div class="faq-page-tab">
                        <div class="section-title-2 mb65 headline text-left">
                            <h2>Free Resource <span>Demo Videos</span></h2>
                        </div>
                            ...
                            <div class="faq-tab-ques  ul-li">
                                <div id="tab2" class="tab-content-1 pt35" style="padding:0 !important;">
                                    <div id="accordion-2" class="panel-group">
                                        @foreach(\App\Video::where('demo', 1)->get() as $f)
                                            <div class=" col-15" >
                                                <div class="panel-title " id="heading11">
                                                    <h3 class="mb-0">
                                                        <button class="btn btn-link collapsed" onclick="toggleVideo('{{$f->vimeo_id}}', '#collapse{{$f->id}}')" data-toggle="collapse" data-target="#collapse{{$f->id}}" aria-expanded="true" aria-controls="collapse11" >{{$f->title}} </button>
                                                    </h3>
                                                </div>
...
<script>
    ...
    function toggleVideo(vimeo_id, element_id){

        
        element = document.createElement('iframe');
        element.id = 'player1';
        element.src = 'https://player.vimeo.com/video/'+vimeo_id+'?api=1&player_id=player1';
        element.width = '100%';
        ...
        if($(element_id).children().eq(0).children().length == 0){
            $(element_id).children().eq(0).append(element);
            last_video.push(element_id);
        }else{
