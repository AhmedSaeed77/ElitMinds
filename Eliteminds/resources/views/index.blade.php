...
@section('content')
    ...
    <div class="section slider-section ">
        ...
        <div class="container">
            ...
            <div class="slider-content">
                ...
                <a class="btn btn-primary btn-hover-dark" href="#courses">Explore Courses</a>
            </div>
            <!-- Slider Content End -->
    ...
    <!-- All Courses Start -->
    <div class="section section-padding-02" id="courses">
        <div class="container">
            ...
            <div class="testimonial-wrapper testimonial-active">
                <div class="swiper-container">
                    ...
                    @foreach($userFeedBack as $feedback)
                        ...
                        <div class="single-testimonial swiper-slide" style='height: 420px;'>
