...
@section('pageTitle') New FAQ Cource @endsection
@section('subheaderTitle')New FAQ Cource @endsection
    ...
    <div class="row" id="app-1" style="background-color: white; padding: 0 0;">
        <div class="col-md-12">
            ...
            <div class="form-horizontal" style="background: white; padding: 30px 15px;">
                ...
                <div class="form-group row">
                    <label class="col-2 col-form-label" for="title" >Title ar :</label>
                    <div class="col-10">
        ...
        const app = new Vue({
            ...
            methods: {
                ...
                storeRequest: async function(){
                    return $.ajax ({
                        type: 'POST',
                        url: '{{ route('admin.store.FaqCorce')}}',
                        data: {
                            title: app.title,
