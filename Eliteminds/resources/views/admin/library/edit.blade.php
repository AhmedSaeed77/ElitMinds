                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tr v-for="(i,index) in chapters">
                                                    <td>@{{ index + 1 }}</td>
                                                    <td @dblclick="edit('chapter', i.id)">@{{ i.title }}</td>
                                                    <td>
                                                        <a href="#" @click.prevent="edit('chapter', i.id)">
                                                            <i class="la la-edit" style="color: #9d223c;"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="#" @click.prevent="deleteItem('chapter', i.id)">
                ...
                methods: {
                    ...
                    addDetails: function(){
                        ...
                        if(this.editIndex === null){
                            ...
                            this.course_details.splice(this.editIndex, 0, {
                                title: this.details_title,
                                description: this.details_description.getData(),
                            });
                        }
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                Swal.fire({
                                    ...
                                    text: 'By Clicking `Yes` You are deleting this item and any other items associated to it! like (questions, videos)',
                                    showCancelButton: true,
                    ...
                    deleteRequest: async function(topic_type, topic_id){
                        return fetch('{{route('library.single.destroy', '')}}/' + topic_type, {
                            method: 'POST',
                            headers: {
                    ...
                    loader: function(path_id){
                        ...
                        $.ajax({
                            ...
                            success: function(res){
                                ...
                                app.course_title_ar = res.title_ar;
                                app.course_title_fr = res.title_fr;
                                app.chapters = res.chapters;
                                app.course_private = res.private ? true: false;
                                app.course_details = res.course_details;
                                KTApp.unblockPage();
                            },
                        });
                    },
                    ...
                    addChapter: function(){
                        ...
                        this.add('chapter', {title: this.chapter_title, title_ar: this.chapter_title_ar} , this.course_id).then(() => {
                            app.loader(app.course_id);
                        });
                    ...
                    _formEl,
                    {
                        fields: {
                            ...
                            course_title_ar: {
                                validators: {
                                    notEmpty: {
                                        message: '{{config('library.course.en')}} Title in arabic is required.'
                                    }
                                }
                            },
                        },
