...
@section('pageTitle') Edit Flash Card @endsection
...
@section('subheaderNav')
    ...
    <!--begin::Button-->
    <a href="#" onclick="AVUtil().redirectionConfirmation('{{route('flashCard.show.admin')}}')" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    <span class="svg-icon svg-icon-success svg-icon-lg">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form-horizontal form-bordered" enctype="multipart/form-data" method="POST" id="flashCardForm" action="{{route('flashCard.edit', $f->id)}}">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group-lg py-5 row">
                    ...
                    <div class="col-md-5">
                        <input class="form-control" type="text" placeholder="Title" name="title" value="{{$f->title}}" />
                    </div>
                ...
                <div class="form-group-lg py-5 row">
                    ...
                    <div class="col-md-11">
                        <textarea class="form-control" maxlength="250" rows="2" name="contant" id="kt-ckeditor-1">{!! $f->contant !!}</textarea>
                    </div>
                </div>
            </div>
