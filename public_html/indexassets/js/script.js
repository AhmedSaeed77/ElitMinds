...
FeedBackSlider: function (){
	$('#feedback-slide-item').owlCarousel({
		margin:85,
		responsiveClass:true,
		nav: true,
		autoplay: true,
...
/* Start Of best product1
================================================*/
bestproductSlide1: function (){

	// new Swiper('#best-product-slide-item1', {
	// 	slidesPerView: 4,
	// 	spaceBetween: 20,
	// 	slidesPerGroup: 1,
	// 	autoplay: true,
	...
	$('#best-product-slide-item1').owlCarousel({
		margin:0,
		responsiveClass:true,
		nav: true,
		dots: false,
